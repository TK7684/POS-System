...
async function processCommand(messageText, messageType, env) {
  ...
  if (text === '' || text === 'help' || text === 'ช่วย' || text === '?' || text === 'help me') {
    return `🤖 พอส Bot - AI Assistant\n\n` +
           ...
           `• "ค่าใช้จ่ายวันนี้" - ดูค่าใช้จ่ายวันนี้\n` +
           `• "รายการซื้อล่าสุด" - ดูรายการซื้อล่าสุด\n` +
           `• "เมนูขายดี" - ดูเมนูที่ขายดีที่สุด\n` +
           `• "ต้นทุนเมนู A1" - คำนวณต้นทุนเมนู\n` +
           `• "สต็อก" - ดูสต็อกที่ใกล้หมด\n` +
           `• "สถิติ" - ดูสถิติค่าใช้จ่าย\n\n` +
